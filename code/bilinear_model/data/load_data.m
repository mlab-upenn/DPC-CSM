function [features_d, features_c, outputs] = load_data(argStr, orderAR, ctrlHzn, estType)
...
features_d = [lagmatrix(d', -(0:1:ctrlHzn-1)), lagmatrix(y(1,:)', 0:1:orderAR-1), proxy']; %#ok<*NODEF>
